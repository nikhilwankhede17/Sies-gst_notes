...
class AddlecsCHEM extends StatefulWidget {
  const AddlecsCHEM({Key? key}) : super(key: key);

  @override
  _AddlecsCHEMState createState() => _AddlecsCHEMState();
}

// Assuming total_lectures is an integer variable
class _AddlecsCHEMState extends State<AddlecsCHEM> {
