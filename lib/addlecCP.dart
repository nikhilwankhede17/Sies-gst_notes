...
class AddlecsCP extends StatefulWidget {
  const AddlecsCP({Key? key}) : super(key: key);

  @override
  _AddlecsCPState createState() => _AddlecsCPState();
}

// Assuming total_lectures is an integer variable
class _AddlecsCPState extends State<AddlecsCP> {
