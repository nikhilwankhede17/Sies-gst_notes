...
class addlecMATHS extends StatefulWidget {
  const addlecMATHS({Key? key}) : super(key: key);

  @override
  _addlecMATHSState createState() => _addlecMATHSState();
}

// Assuming total_lectures is an integer variable
class _addlecMATHSState extends State<addlecMATHS> {
