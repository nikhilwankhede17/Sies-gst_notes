...
class Addlecs extends StatefulWidget {
  const Addlecs({Key? key}) : super(key: key);

  @override
  _AddlecsState createState() => _AddlecsState();
}

 // Assuming total_lectures is an integer variable
class _AddlecsState extends State<Addlecs> {
