...
class AddlecsPCCOE extends StatefulWidget {
  const AddlecsPCCOE({Key? key}) : super(key: key);

  @override
  _AddlecsPCCOEState createState() => _AddlecsPCCOEState();
}

// Assuming total_lectures is an integer variable
class _AddlecsPCCOEState extends State<AddlecsPCCOE> {
